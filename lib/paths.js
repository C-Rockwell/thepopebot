...
export const securityFile = path.join(PROJECT_ROOT, 'config', 'SECURITY.json');
export const memoryFile = path.join(PROJECT_ROOT, 'config', 'MEMORY.json');
export const voiceFile = path.join(PROJECT_ROOT, 'config', 'VOICE.json');
export const observeFile = path.join(PROJECT_ROOT, 'config', 'OBSERVE.json');
