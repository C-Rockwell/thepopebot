...
import { createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getPiSkillCreationGuideTool, searchMemoryTool } from './tools.js';
...
export async function getAgent() {
  if (!_agent) {
    ...
    const tools = [createJobTool, getJobStatusTool, getSystemTechnicalSpecsTool, getPiSkillCreationGuideTool, searchMemoryTool];
