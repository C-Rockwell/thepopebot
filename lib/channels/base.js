...
class ChannelAdapter {
  ...
  /**
   * Send a voice/audio response back to the channel.
   * @param {string} threadId - Channel-specific thread/chat ID
   * @param {Buffer} audioBuffer - Audio data
   * @param {object} metadata - Channel-specific metadata
   * @param {object} [options] - Additional options (e.g., mimeType, format)
   */
  async sendVoiceResponse(threadId, audioBuffer, metadata, options) {}

  /**
   * Whether this channel supports voice output (TTS responses).
   */
